...
public class CourseServiceImplTest
{
    ...
    @Test
    public void findCourseById(){assertEquals("test Wing Chun", courseService.findCourseById(12).getCoursename());}

    @Test(expected = ResourceNotFoundException.class)
    public void notFindCourseById()
    {
        assertEquals("test Wing Chun", courseService.findCourseById(999).getCoursename());
    }
