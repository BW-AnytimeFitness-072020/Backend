...
//        long sizecapacity,
//        User instructor)
        Course c2 = new Course("test Wing Chun", "Combat",6, 45, "Easy", "Virginia", "2020-01-01",15 ,u5);
        Course c7 = new Course("test Jiu Jitsu", "Combat",19, 30, "Hard", "Brazil", "2020-01-10",110 ,u5);
        Course c6 = new Course("test Hip Hop", "Dance",9, 60, "Easy", "Texas", "2020-01-10",45 ,u5);
        Course c3 = new Course("test Tibo", "Cardio",19, 30, "Medium", "California", "2020-01-10",100 ,u3);
        Course c4 = new Course("test YOGA", "cardio",8, 45, "Easy", "Indiana", "2020-01-10",55 ,u3);
        Course c9 = new Course("test HIIT", "Cardio",19, 30, "Medium", "Kentucky", "2020-01-10",105 ,u3);
        Course c10 = new Course("test Parkour", "Cardio",17, 80, "Hard", "New York", "2020-01-10",55 ,u3);
        Course c1 = new Course("test Zoomba", "Cardio",12, 50, "Medium", "Florida", "2020-01-10",25 ,u1);
        Course c5 = new Course("test Ballet", "Dance",13, 50, "Hard", "New Jersey", "2020-01-10",25 ,u1);
        Course c8 = new Course("test YOGA", "cardio",8, 45, "Easy", "Michigan", "2020-01-10",55 ,u1);
